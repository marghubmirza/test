...
def sector_report(sectors, engine):
    ...
    results = f"The cumulative return for the {sector} sector for the past year is {(sector_yearly_rtn * 100):0.4f}%.\nWould you like to choose another sector to analyze?"
